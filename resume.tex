...
\begin{document}
    ...
    \noindent\begin{minipage}[t]{1\textwidth}
      ...
      \begin{addmargin}[.5em]{0em}
        ...
        \begin{itemize}
            ...
            \item {Worked with finance team to lead a project automating the
              import + upload + charging of monthly billing spreadsheets. This
              {\bf prevented the org from doing 100s of hours of manual, repetitive,
              error-prone tasks}}
      ...
      \vspace{.25em}
      \begin{addmargin}[.5em]{0em}
        {\bf Software Engineer} {\hfill Mar 2019 - Aug 2019}
        \vspace{-.5em}
        \begin{itemize}
            \setlength\itemsep{-.2em}
      ...
      {\bf The Business Garage}
      \vspace{.25em}
      \begin{addmargin}[.5em]{0em}
        {\bf Junior Software Engineer} {\hfill Feb 2018 - Mar 2019}
        \vspace{-.5em}
        \begin{itemize}
            \setlength\itemsep{-.2em}
